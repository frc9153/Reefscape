...
class ScoreTrough(commands2.SequentialCommandGroup):
    def __init__(self, liftsub: LiftSubsystem, jointsub: JointSubsystem, grabbersub: GrabberSubsystem, drivesub: DriveSubsystem, robot_gyro: TransformableGyro):
        ...
        self.addCommands(
            HeatSeekingMissileLockheedMartinAlign(drivesub, HeatSeekingMissileLockheedMartinConstants.offset_reef_center),
